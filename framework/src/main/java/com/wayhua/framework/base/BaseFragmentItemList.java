...
import com.wayhua.framework.ThrowableLoader;
import com.wayhua.framework.adapter.HeaderFooterListAdapter;
 ...
 */
public abstract class BaseFragmentItemList<E> extends BaseFragment  implements
     ...
     */
    protected BaseFragmentItemList<E> notifyDataSetChanged() {
     ...
     * @return this fragment
     */
    protected BaseFragmentItemList<E> setListAdapter(final ListAdapter adapter) {
        if (listView != null)
            listView.setAdapter(adapter);
        return this;
    }

    private BaseFragmentItemList<E> fadeIn(final View view, final boolean animate) {
        if (view != null)
            if (animate)
    ...
    private BaseFragmentItemList<E> show(final View view) {
        ViewUtils.setGone(view, false);
        return this;
    }

    private BaseFragmentItemList<E> hide(final View view) {
     ...
     * @return this fragment
     */
    public BaseFragmentItemList<E> setListShown(final boolean shown) {
     ...
     * @return this fragment
     */
    protected BaseFragmentItemList<E> setEmptyText(final String message) {
        if (emptyView != null)
     ...
     * @return this fragment
     */
    protected BaseFragmentItemList<E> setEmptyText(final int resId) {
        if (emptyView != null)

...
public abstract class BaseFragmentTabPager<V extends PagerAdapter & FragmentProvider>
        extends BaseFragmentPager implements OnTabChangeListener, TabContentFactory {
     ...
     */
    protected BaseFragmentTabPager<V> setGone(boolean gone) {
    ...
    private void createPager() {
        ...
        //     slidingTabsLayout.setTabMode(TabLayout.MODE_FIXED);
